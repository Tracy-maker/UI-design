        ...
        <div className="flex flex-col md:flex-row items-center justify-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-white mb-2 text-justify">
              <strong className="font-semibold">Navigation Design:</strong> The app must be easy to navigate, allowing users to find the flowers and related information they want easily.
            </p>
