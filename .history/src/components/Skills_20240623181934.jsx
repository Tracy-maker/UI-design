    ...
    <Section className="bg-gray-800 p-6 rounded-lg shadow-lg">
      <div className="flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="w-full lg:w-1/2 text-white lg:pl-8">
          <motion.h2
            className="font-black text-[24px] sm:text-[28px] md:text-[32px] lg:text-[36px] xl:text-[40px] leading-tight mb-4"
          ...
          <motion.p
            className="text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px] xl:text-[24px] mb-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
