      ...
      <div>
        <div className="flex flex-col md:flex-row items-center justify-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-white text-justify">
              <strong className="font-semibold">Solution:</strong> Use card-based design to display each flower item, including images, names, and prices. Maintain proper spacing between cards to avoid a cluttered interface.
            </p>
          </motion.div>
        </div>
      </div>
