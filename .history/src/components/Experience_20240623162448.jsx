        ...
        <div className="flex flex-col md:flex-row items-center justify-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-white text-justify">
              <strong className="font-semibold">Solution:</strong> Employ a simple navigation menu and clear category labels such as "Birthday Bouquets," "Celebration Bouquets," etc. Use a bottom navigation bar for quick access to main features.
            </p>
          </motion.div>
        </div>
      </div>
