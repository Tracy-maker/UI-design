      ...
      <div className="flex flex-col items-center">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-lg mb-8">
          ...
          <p className="text-gray-700">
            The flower shop mobile app features a clean, user-friendly interface
            with soft pastel colors and flower-themed icons. It offers intuitive
            navigation, engaging interactive elements, and a visually appealing
            layout. The design ensures a seamless user experience across
