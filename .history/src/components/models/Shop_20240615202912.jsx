...
useEffect(() => {
  ...
  const handlePointerDown = (event) => {
    ...
    console.log("Pointer Down at", lastX.current);
  };
    ...
    if (isRotating) {
      ...
      if (isShopRef.current) {
        ...
        console.log("Pointer Move", {
          clientX,
          delta,
          rotationY: isShopRef.current.rotation.y,
        });
      } else {
        console.log("isShopRef.current is null");
      }
  ...
  useEffect(() => {
    ...
    const testPointerDown = () => console.log("Test Pointer Down");
    canvas.addEventListener("pointerdown", testPointerDown);
  
    return () => {
      canvas.removeEventListener("pointerdown", testPointerDown);
    };
  }, [gl]);

  useEffect(() => {
    console.log("isShopRef", isShopRef.current);
  }, [isShopRef.current]);
  ...
  useFrame(() => {
    if (!isRotating) {
      ...
      if (isShopRef.current) {
        ...
        console.log("Frame Update: isShopRef.current is null");
      }
    }
  });
