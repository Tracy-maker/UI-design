...
import isShop from "../../assets/3d/ancient_greek_book_shop.glb";
import { a } from "@react-spring/three";

const Shop = (props) => {
  const { nodes, materials } = useGLTF("/ancient_greek_book_shop.glb");
  return (
...
useGLTF.preload("/ancient_greek_book_shop.glb");
