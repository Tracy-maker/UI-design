...
const Challenge = () => {
  return (
    <Section>
      <div>
        <h1 className="text-center text-4xl font-extrabold text-gray-800 mb-8">The Challenge</h1>
        <div className="flex flex-col md:flex-row items-center justify-center">
          ...
          <div className="w-full md:w-1/2 text-left md:pl-8">
            ...
            <p className="text-lg text-gray-700 mb-4">
              <strong className="font-semibold">Visual Appeal:</strong> The flower shop app needs to be
            ...
            <p className="text-lg text-gray-700">
              <strong className="font-semibold">Solution:</strong> Use soft colors like pink, light blue,
