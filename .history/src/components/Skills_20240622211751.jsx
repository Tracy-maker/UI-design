  ...
  return (
    <Section className="bg-gray-900 p-4 sm:p-6 md:p-8 rounded-lg shadow-lg">
      ...
      <div className="flex-1 flex flex-col justify-center pt-2 sm:pt-4 md:pt-8 lg:pr-4">
        <motion.h2
          className="font-black text-white text-[18px] sm:text-[24px] md:text-[30px] lg:text-[35px] xl:text-[40px] leading-tight mt-2"
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {skills.map((skillCategory, categoryIndex) => (
            <div key={categoryIndex} className="mb-6 bg-gray-800 p-4 rounded-lg shadow-md">
              <motion.h3
                className="font-bold text-sm sm:text-md text-white mb-2"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
