  ...
  return (
    <Section className="flex items-center justify-center min-h-screen p-4 bg-gray-100">
      <div className="flex flex-col items-center w-full max-w-5xl">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center text-purple-600 mb-12">
          Contact me
        </h2>
        <div className="flex flex-col lg:flex-row items-center justify-between w-full space-y-8 lg:space-y-0 lg:space-x-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg w-full lg:w-1/2">
            <form>
              <label
                htmlFor="name"
                className="font-medium text-purple-900 block mb-2"
              >
                Name
              </label>
              <input
              ...
              />
              <button className="bg-purple-600 text-white py-3 px-6 rounded-lg font-bold text-lg w-full hover:bg-purple-700 transition">
                Submit
              </button>
            </form>
          </div>
