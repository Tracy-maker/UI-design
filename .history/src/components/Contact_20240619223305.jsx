      ...
      <div className="flex flex-col items-center">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-lg mb-8">
          ...
          <p className="text-gray-700">
            The flower shop app features a clean interface, pastel colors, and flower icons. It ensures easy navigation, interactive elements, and a visually pleasing layout.
          </p>
        </div>
