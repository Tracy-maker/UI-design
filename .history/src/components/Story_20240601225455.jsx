...
const Story = () => {
  ...
  return (
    <section className="relative w-full h-screen grid grid-cols-2 grid-rows-2">
      <div className="p-5 row-span-1 col-span-1 flex justify-center items-start">
      ...
      <div className="row-span-2 col-span-2 flex mt-auto my-auto">
        <Canvas
