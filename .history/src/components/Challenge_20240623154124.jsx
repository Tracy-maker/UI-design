...
const Challenge = () => {
  return (
    <Section>
      <div className="p-4">
        <h1 className="text-center text-2xl font-bold mb-4">The Challenge</h1>
        <div className="flex flex-col md:flex-row items-center justify-between">
          <img
            src={About}
            alt="About Us"
            className="rounded-lg shadow-md mb-4 md:mb-0 md:mr-4 w-full md:w-1/2"
          />
          <div className="text-left max-w-md md:ml-4">
