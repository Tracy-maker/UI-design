...
import menu from './assets/menu.svg';  // Update the path as per your project structure
import close from './assets/close.svg'; // Update the path as per your project structure
import styles from './styles.module.css'; // Update the path as per your project structure
