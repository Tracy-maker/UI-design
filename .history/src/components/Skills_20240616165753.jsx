...
const Skills = () => {
  return (
    <Section className="flex flex-col lg:flex-row items-center justify-center p-4 min-h-screen">
      ...
      <div className="flex-1 flex flex-col justify-center items-end pt-2 sm:pt-8 lg:pl-4 text-right">
        <motion.h2
        ...
        <div className="mt-8 space-y-4 w-full flex flex-col items-end">
          {skills.map((skill, index) => (
            ...
            >
              <motion.h3
                className="text-md lg:text-lg font-bold text-right w-full"
                initial={{ opacity: 0 }}
              ...
              <motion.div
                ...
                style={{
                  ...
                  width: `${skill.level}%`,
                  transformOrigin: 'right', // Align progress bar to the right
                }}
                initial={{ scaleX: 0, originX: 1 }} // Adjust originX to 1 for right alignment
