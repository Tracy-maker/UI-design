...
const About = () => {
  return (
    <Section className="flex flex-col lg:flex-row items-center justify-center lg:justify-between p-4 min-h-screen">
      <div className="flex-1 pt-2 sm:pt-8 lg:pr-4 flex flex-col justify-center">
        <motion.h1
