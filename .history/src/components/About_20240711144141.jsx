  ...
  return (
    <Section>
      ...
      >
        ...
        >
          Hi, I'm <span className="text-[#915EFF]">Yingxin Zhang</span>
        </motion.h1>
        <motion.p
        ...
        >
          I am a Web Developer & UI designer, <br className="sm:block hidden" />
          and this is my portfolio <br className="sm:block hidden" />
