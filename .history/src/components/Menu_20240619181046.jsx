    ...
    <>
      <div className="z-20 fixed top-12 right-12 flex items-center gap-3">
        <motion.button
          ...
          className="p-3 bg-white w-11 h-11 rounded-md shadow-md"
      ...
      <motion.div
        className={`z-10 fixed top-0 right-0 bottom-0 bg-gray-800 bg-opacity-90 overflow-hidden flex flex-col ${
          menuOpened ? "w-80" : "w-0"
        }`}
        initial={{ width: 0 }}
      ...
      >
        <div className="flex-1 flex items-start justify-center flex-col gap-6 p-8">
          <div className="text-white text-[48px] sm:text-[40px] font-bold cursor-pointer flex items-center mb-8">
            Yi{" "}
            <img
              src={pinwheel}
              alt="pinwheel"
