...
const Skills = () => {
  return (
    <Section className="bg-gray-900 p-4 sm:p-8 rounded-lg shadow-lg">
      ...
      <div className="flex-1 flex flex-col justify-center pt-2 sm:pt-8 lg:pr-4">
        <motion.h2
          className="font-black text-white text-[24px] sm:text-[30px] md:text-[35px] lg:text-[40px] xl:text-[45px] 2xl:text-[50px] leading-tight mt-2"
          ...
          {skills.map((skillCategory, categoryIndex) => (
            <div key={categoryIndex} className="mb-6 bg-gray-800 p-4 rounded-lg shadow-md">
              ...
              {skillCategory.items.map((item, itemIndex) => (
                ...
                >
                  <motion.h4
                    className="text-md lg:text-lg font-bold text-white"
                    initial={{ opacity: 0 }}
