  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          <p className="text-white text-[35px] sm:text-[28px] font-bold cursor-pointer flex ">
            Yi{" "}
            <img src={pinwheel} alt="pinwheel" className="w-7 h-7 mt-2.5 object-contain " />
            &apos;s&nbsp;
        ...
        <ul className="list-none hidden sm:flex flex-row gap-7">
          {navLinks.map((link) => (
            <li
              ...
              } hover:text-white text-[24px] sm:text-[20px] font-medium cursor-pointer`}
